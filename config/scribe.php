...
return [
     ...
     */
    'title' => "Laravel JSON API Demo Docs",
    ...
    'routes' => [
        [
            ...
            'apply' => [
                 ...
                 */
                'headers' => [
                    'Content-Type' => 'application/json', // application/vnd.api+json for Laravel JSON Api
                    'Accept' => 'application/json', // application/vnd.api+json for Laravel JSON Api
                ],
