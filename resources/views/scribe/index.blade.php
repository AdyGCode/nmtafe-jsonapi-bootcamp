...
<head>
    ...
    <title>Laravel JSON API Demo Docs</title>
    ...
    <script>
        var tryItOutBaseUrl = "http://nmtafe-jsonapi-bootcamp.test";
        var useCsrf = Boolean();
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-v1-posts">Fetch zero to many JSON API resources.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-posts--id-">
                                <a href="#endpoints-GETapi-v1-posts--id-">Fetch zero to one JSON API resource by id.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<aside>
    <strong>Base URL</strong>: <code>http://nmtafe-jsonapi-bootcamp.test</code>
</aside>
...
<div class="bash-example">
    ...
    --get "http://nmtafe-jsonapi-bootcamp.test/api/user" \
...
<div class="javascript-example">
    ...
    "http://nmtafe-jsonapi-bootcamp.test/api/user"
);
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://nmtafe-jsonapi-bootcamp.test/api/healthcheck" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://nmtafe-jsonapi-bootcamp.test/api/healthcheck"
);
...
<p>Map of each downstream service and their status (<code>up</code> or <code>down</code>).</p>
                        ...
                        <h2 id="endpoints-GETapi-v1-posts">Fetch zero to many JSON API resources.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://nmtafe-jsonapi-bootcamp.test/api/v1/posts" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://nmtafe-jsonapi-bootcamp.test/api/v1/posts"
);
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;file&quot;: &quot;/var/www/html/vendor/laravel-json-api/laravel/src/Http/Requests/ResourceQuery.php&quot;,
    &quot;line&quot;: 338,
    &quot;trace&quot;: [
        {
            &quot;file&quot;: &quot;/var/www/html/vendor/laravel-json-api/laravel/src/Http/Requests/ResourceQuery.php&quot;,
        ...
        {
            &quot;file&quot;: &quot;/var/www/html/vendor/laravel-json-api/laravel/src/Http/Requests/RequestResolver.php&quot;,
            &quot;line&quot;: 111,
            &quot;function&quot;: &quot;make&quot;,
            &quot;class&quot;: &quot;Illuminate\\Foundation\\Application&quot;,
            &quot;type&quot;: &quot;-&gt;&quot;
        ...
        {
            &quot;file&quot;: &quot;/var/www/html/vendor/laravel-json-api/laravel/src/Http/Controllers/Actions/FetchMany.php&quot;,
            &quot;line&quot;: 41,
            &quot;function&quot;: &quot;queryMany&quot;,
            &quot;class&quot;: &quot;LaravelJsonApi\\Laravel\\Http\\Requests\\ResourceQuery&quot;,
            &quot;type&quot;: &quot;::&quot;
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-posts--id-">Fetch zero to one JSON API resource by id.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://nmtafe-jsonapi-bootcamp.test/api/v1/posts/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://nmtafe-jsonapi-bootcamp.test/api/v1/posts/1"
);
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;trace&quot;: [
        ...
        {
            &quot;file&quot;: &quot;/var/www/html/vendor/laravel-json-api/laravel/src/Http/Controllers/Actions/FetchOne.php&quot;,
            &quot;line&quot;: 41,
            &quot;function&quot;: &quot;queryOne&quot;,
            &quot;class&quot;: &quot;LaravelJsonApi\\Laravel\\Http\\Requests\\ResourceQuery&quot;,
            &quot;type&quot;: &quot;::&quot;
